...
const NotificationPanel = ({ onClose }) => {
  return (
    <motion.div
      ...
      className=" w-60 fixed top-0 right-0 md:w-80 h-full bg-white shadow-lg p-4 z-50"
    >
      {/* Header */}
      <div className='flex justify-between items-center border-b pb-2'>
        <h2 className='text-xl font-bold'>Notifications</h2>
        <button onClick={onClose} className='text-pink-600 cursor-pointer font-extrabold text-3xl leading-none'>×</button>
      </div>
