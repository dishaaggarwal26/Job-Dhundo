...
const Signup = () => {
    ...
    <div className="mb-20 mt-20 flex justify-evenly items-center">
        <div><img className=" w-0 h-0 md:h-120 md:w-full" src="https://img.freepik.com/free-vector/two-factor-authentication-concept-illustration_114360-5598.jpg?ga=GA1.1.843000903.1731528873&semt=ais_hybrid" alt="signuplogo" srcset="" /></div>
