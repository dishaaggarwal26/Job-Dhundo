    ...
    <div>
      ...
      <div className='mt-25'>
        ...
        <div className=' flex flex-col gap-3  md:flex-row justify-evenly items-center mt-20'><img className='shadow-2xl rounded-2xl w-80 h-60' src="https://media.istockphoto.com/id/1394701218/photo/job-search-concept-find-your-career-woman-looking-at-online-website-by-laptop-computer-people.jpg?s=612x612&w=0&k=20&c=V32cT3dAoI7plQSnV-i7YxP43YvaoyA0jLS4729gNWM=" alt=""  />
          <img className='w-80 h-60 rounded-2xl shadow-2xl' src="https://thumbs.dreamstime.com/b/text-sign-showing-re-hiring-conceptual-photo-advertising-employment-workforce-placement-new-job-woman-wear-formal-work-suit-161388358.jpg" alt=""  /></div>
      </div>
      <div className='flex flex-col  mt-30 bg-blue-100  md:flex md:flex-row justify-evenly items-center'>
        ...
        <div className='grid mb-1.5 grid-cols-3 mt-10 gap-2 md:mb-5'>
          <img className='rounded-xl w-40 h-30 ' src="https://kinsta.com/wp-content/uploads/2021/11/front-end-developer.png" alt=""  />
          <img className='rounded-xl w-40 h-30' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRviIewOJYhPWycs2EcfS8cAznXsS3BQYgirRJRaCxkPnL_nToQFAlrTTA-syW_eCIZQlQ&usqp=CAU" alt="" />
          <img className='rounded-xl w-40 h-30' src="https://jaro-website.s3.ap-south-1.amazonaws.com/2024/08/programming-background-with-person-working-with-codes-computer_23-2150010125.jpg" alt="" />
          <img className='rounded-xl w-40 h-30' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqEsJ5pHJ8tsGNEPUTGrl1SuGLdtcfzBDAag&s" alt=""  />
          <img className='rounded-xl w-40 h-30' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQibywTsVdlGUUM3JQIN3jf4p0MfSxEQ1EMi-BwcyWl366y48RzcE3KhcTBgeKgWDQsFno&usqp=CAU" alt=""  />
          <img className='rounded-xl w-40 h-30' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS9FODdRcN6U4_vEcz_lXSmvXX2oSVBPJ4K-Kebb5FJfKsvDvgX7_WpHs80bVr20uBaURY&usqp=CAU" alt=""  />
        </div>
      </div>
