        ...
        <Link to="/">
          ...
          <div className="text-2xl flex items-center gap-2 font-bold">
            <img
              ...
              src="https://png.pngtree.com/png-clipart/20190924/original/pngtree-organization-icon-in-trendy-style-isolated-background-png-image_4844381.jpg"
              alt="logo"
            />
        ...
        <div className="hidden lg:block space-x-6 ">
          <div className="flex items-center gap-7">
            <Link to="/Notifications">
              <IoIosNotifications className="text-pink-600 text-3xl cursor-pointer hover:text-amber-50" />
            </Link>
            <Link to="/Join">
              {" "}
              <button className="cursor-pointer font-semibold bg-pink-600 text-white rounded px-6 py-2">
                Join Now
              </button>
            </Link>
