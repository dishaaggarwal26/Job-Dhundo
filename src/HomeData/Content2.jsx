...
className='container '>
  <div 
   className="space-y-4 p-6 text-centre max-w-[500px] mx-auto mb-5">
    <h1 className='uppercase font font-semibold text-pink-500'>Why Choose Us</h1>
...
{ Content2data.map((item)=>{
   ...
   whileInView={"visible"}
     className='w-60 ml-10 space-y-4 p-8 rounded-xl shadow-[0_0_22px_rgba(0,0,0,0.15)] md:ml-0 lg:ml-0'>
      ...
      <div 
      style={{backgroundColor:item.bgColor}} className='w-10 h-10 rounded-lg flex justify-center items-center text-white'>
